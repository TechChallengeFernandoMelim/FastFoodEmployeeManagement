...
namespace FastFoodEmployeeManagement.Tests.Core.Application.UseCases;
...
public class ValidationBehaviorTests
{
    ...
    public async Task Handle_WithInvalidRequest_ThrowsValidationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<FastFoodEmployeeManagement.Domain.Exceptions.ValidationException>(() => behavior.Handle(request, null, cancellationToken));
    }
