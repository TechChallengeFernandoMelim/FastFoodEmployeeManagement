...
namespace FastFoodEmployeeManagement.Tests.Infrastructure.Logger;
...
public class LoggerTests
{
    ...
    public async Task Log_ValidInput_Success()
    {
        ...
        var sqsService = new FastFoodEmployeeManagement.Infrastructure.SQS.Logger.Logger(sqsClientMock.Object);
